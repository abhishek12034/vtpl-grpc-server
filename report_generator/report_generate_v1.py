...
class GenerateReport:
    ...
    def generate_report(self, output_dir='report'):
        ...
        doc.preamble.append(NoEscape(r'\titleformat{\section}{\color{sectioncolor}\Large\bfseries}{\thesection}{1em}{}'))
        
        # Headers and footers
        doc.preamble.append(NoEscape(r'\pagestyle{fancy}'))
        doc.preamble.append(NoEscape(r'\fancyhead[L]{Videonetics Technologies Pvt. Ltd.}'))
        ...
        # Document preamble
        doc.preamble.append(Command('title', NoEscape(r'\textcolor{titlecolor}{Image Adjustment Operations Report}')))
        ...
        doc.append(NoEscape(r'\includegraphics[width=0.28\textwidth]{D:/Projects/Forensic/vtpl-grpc-server/report_generator/images/videonetics_logo.jpg}'))
        ...
        def add_operation_section(title, description, input_img_path, output_img_path):
            with doc.create(Section(title)):
                ...
                if show_report == "True":
                    ...
                    doc.append(NoEscape(r'\hfill'))  # Add horizontal space between images
                    ...
                    doc.append(NoEscape(r'\end{minipage}'))
                    doc.append(NoEscape(r'\vspace{1em}'))  # Add some vertical space after images
